  ...
  return (
    <div>
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto ">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-bold lg:text-6xl text-blue-500 dark:text-purple-600 ">
              Welcome to{" "}
              <span className="dark:text-yellow-200 text-green-400">Pra</span>{" "}
              Bank
            </h1>
      ...
      <div className="flex flex-col items-center">
        <h1 className="text-xl font-bold lg:text-3xl text-center mb-8 underline">
          Our Quality
        </h1>
